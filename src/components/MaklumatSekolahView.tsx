    ...
    <div className="bg-white rounded-[20px] p-6 lg:p-7 shadow-[0_4px_24px_rgba(0,0,0,0.03)] border border-gray-100/80 h-full flex flex-col">
       <div className="flex justify-between items-center mb-6">
          ...
          <div className="relative inline-flex items-center shrink-0">
            <div className="flex items-center gap-2 text-[11px] sm:text-xs font-bold text-gray-600 bg-white border border-gray-200 rounded-lg px-3 py-1.5 shadow-sm whitespace-nowrap">
              <span>{selectedDate ? (() => {
                 const [y, m, d] = selectedDate.split('-');
                 return `${d}/${m}/${y}`;
              })() : 'dd/mm/yyyy'}</span>
              <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>
            </div>
            <input 
              type="date"
              value={selectedDate} 
